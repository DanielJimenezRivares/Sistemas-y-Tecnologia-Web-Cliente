...
})({"b0p5N":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8590514ae3533b6d";
"use strict";
...
/* ------------------ search-valoraciones (orquestador) ------------------ */ class SearchValoraciones extends HTMLElement {
    constructor(){
        super();
        this.attachShadow({
            mode: 'open'
...
/* ------------------ valoraciones-list ------------------ */ class ValoracionesList extends HTMLElement {
    constructor(){
        super();
        this.attachShadow({
            mode: 'open'
...
},{}]},["b0p5N","iXNhy"], "iXNhy", "parcelRequire05b6", {})

//# sourceMappingURL=web.e3533b6d.js.map
